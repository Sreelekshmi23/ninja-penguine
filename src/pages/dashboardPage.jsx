...
function RequestCard({ request, onAction, primaryColor, onViewImage, onGenerate, onEdit }) {
        ...
        {isPending ? (
          <>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-blue font-medium bg-white  border-gray-200 shadow-sm
              ${isEditing ? "bg-green-600" : "bg-white-600"}
              `}
            >
              {isEditing ? "Save" : "Edit"}
            </button>
